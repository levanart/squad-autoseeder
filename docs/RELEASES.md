...
После успешной сборки GitHub Actions создаёт черновик GitHub Release. Перед публикацией вручную проверьте `SHA256SUMS.txt`, `release-manifest.json` и содержимое архива. Уже опубликованный релиз workflow не перезаписывает.
